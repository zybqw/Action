...
declare function dateHelper(date: moment.Moment | moment.MomentInput, format: string): string;
declare function timeHelper(date: moment.Moment | moment.MomentInput, format: string): string;
declare function fullDateHelper(date: moment.Moment | moment.MomentInput, format: string): string;
declare function relativeDateHelper(date: moment.Moment | moment.MomentInput): string;
declare function timeTagHelper(date: string | number | Date | moment.Moment, format: string): string;
/**
